...
# 📖 Crypto Tracker project <a name="about-project"></a>

> A mobile web application to check a list of crypto metrics (mainly numeric) using the coinstat API. React and Redux were used.
...
- **[Allows users to filter coins based on search input ...]**
- **[Allows users to get more details of coins on click ...]**  
...
> <p> git clone https://github.com/EmekaEmmanuel/coin_track.git</p>
> cd coin_track
...
Feel free to check the [issues page](https://github.com/EmekaEmmanuel/coin_track/issues).
